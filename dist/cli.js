...
var getGlyphsData = function (files, options) {
    ...
    return Promise.all(files.map(function (srcPath) { return throttle(function () { return new Promise(function (resolve, reject) {
        ...
        var ligatures = options.ligatures;
...
var getOptions = function (initialOptions) {
    ...
    return __assign({ centerHorizontally: false, centerVertically: false, descent: 0, fixedWidth: false, fontHeight: null, fontId: null, fontName: "webfont", fontStyle: "", fontWeight: "", formats: ["svg", "ttf", "eot", "woff", "woff2"], formatsOptions: {
            ttf: {
                copyright: null,
                ts: null,
                version: null
            }
        }, glyphTransformFn: null, ligatures: true, 
        /*
...
if (meowCLI.flags.centerVertically) {
    optionsBase.centerVertically = meowCLI.flags.centerVertically;
}
...
if (meowCLI.flags.ligatures === false) {
    optionsBase.ligatures = meowCLI.flags.ligatures;
}
